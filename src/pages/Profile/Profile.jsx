          ...
          {totalSessions > 0 && (
            <ErrorBoundary level="component">
              <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                ...
                <div className="card p-6">
                  <h2 className="mb-6 font-heading text-xl font-bold text-gray-900">
                    Your Progress
                  </h2>
          ...
          {totalSessions === 0 && !isLoading && (
            <div className="card bg-gradient-to-br from-primary-50 to-secondary-50 p-8 text-center">
              ...
              <p className="mb-6 text-gray-600">
                You haven't started any sessions yet. Begin your journey of building deeper
                connections by starting your first game session.
              </p>
