...
function* updateUserPreferencesSaga(action) {
  try {
    ...
    yield put(
      userActions.updateUserPreferencesSuccess({
...
function* updateLanguageSaga(action) {
  try {
    ...
    yield put(
      userActions.updateLanguageSuccess({
...
function* getUserStatisticsSaga() {
  try {
    ...
    yield put(
      userActions.getUserStatisticsSuccess({
...
function* recordGameCompletionSaga(action) {
  try {
    ...
    yield put(
      userActions.recordGameCompletionSuccess({
...
function* getUserDecksSaga(action) {
  try {
    ...
    yield put(
      userActions.getUserDecksSuccess({
        decks,
      })
    );
  } catch (error) {
...
function* getPurchaseHistorySaga() {
  try {
    ...
    yield put(
      userActions.getPurchaseHistorySuccess({
        purchases,
      })
    );
  } catch (error) {
