...
export const userSelectors = {
  ...
  getUserProgress: createSelector(
      ...
      (statistics) => {
        ...
        return {
          ...
          experienceLevel: totalSessions < 5 ? 'beginner' : totalSessions < 20 ? 'intermediate' : 'advanced'
        };
      }
    ),
    ...
    getRecommendations: createSelector(
      ...
      (statistics, unlockedDecks) => {
        ...
        const untried = ['friends', 'colleagues', 'new_couples', 'established_couples', 'family']
